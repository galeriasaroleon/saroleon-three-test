...
// import testJpg from '@/assets/img/testphoto.jpg'

export default {
  name: 'VirtualGallery',
  layout: 'virtualGallery',
  ...
  mounted () {
    ...
    // this.initLensFlares()
    // this.loadGeometries()
    // this.flyControlModel()
    // this.initStats()
    // this.orbitControlModel()

    // this.onWindowResize() // => hace que el modelo 3D sea responsive al contenedor que lo contiene
    // this.launchApp()
  },

  methods: {
    /* loadGeometries () {
      const texture = new THREE.TextureLoader().load(this.test)
